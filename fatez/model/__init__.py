...
class BERTTrainer:
    ...
    def __init__(self,
        ...
        # Use Negative Log Likelihood Loss function to predict the masked_token
        self.criterion = nn.NLLLoss(ignore_index = 0)
        self.log_freq = log_freq
		n_paras = sum([p.nelement() for p in self.model.parameters()])
        print("Total Parameters:", n_paras)
    ...
    def iteration(self, epoch, data_loader, train=True):
        ...
        for i, data in data_iter:
            ...
            # Negative Log Likelihood loss of is_next classification result
            ...
            # Adding next_loss and mask_loss
    ...
    def save(self, epoch, file_path:str = "output/bert_trained.model"):
        """
