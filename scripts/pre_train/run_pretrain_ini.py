...
print('input pretrain index:',pretrain_idx_use)
...
matrix2 = PreprocessIO.input_csv_dict_df('/storage/peiweikeLab/jiangjunyao/fatez/pp/celloracle_edge/',df_type ='edge')
...
for epoch in range(num_epoch):
    ...
    report_train.to_csv(
        data_save_dir +'report/epoch1/' + config_name+'_pretrainindex'+str(pretrain_idx_use)+'.csv',
        mode='a',
        header=False
    )
