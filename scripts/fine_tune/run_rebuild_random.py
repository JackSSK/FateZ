...
model_dir = '/storage/peiweikeLab/jiangjunyao/fatez/pre_train/model_tf/epoch1/config1.json_pretrainindex2_pre_train.model'
...
for config_name in config_list:
    ...
    for i in range(epoch):
        ...
        print(node_rec)
        out1.to_csv(data_save_dir+'loss_random'+'.csv',mode='a+')
        report_cor.to_csv(
            data_save_dir +'cor_random' + '.csv',
            mode='a+')
    ...
    print('---prediction result hap---')
    print(np.array(predict_all_cor_atac_hap).mean())
    ### ery
    ...
    print('---prediction result ery---')
    print(np.array(predict_all_cor_atac_ery).mean())
    ### bp
    ...
    print('---prediction result ery---')
    print(np.array(predict_all_cor_atac_bp).mean())
