...
import torch
### input
node_dir = '/storage/peiweikeLab/jiangjunyao/fatez/fine_tune/rebuild/data/GSE205117_endo/node/'
edge_dir = '/storage/peiweikeLab/jiangjunyao/fatez/pp/celloracle_edge_tf/'
edge_label = pd.read_table('/storage/peiweikeLab/jiangjunyao/fatez/pp/label2/GSE205117.txt')
...
prev_model_dir = '/storage/peiweikeLab/jiangjunyao/fatez/fine_tune/rebuild/result/test_overfit_endotest208-2dim_model.model'
outdir = '/storage/peiweikeLab/jiangjunyao/fatez/fine_tune/rebuild/result/'
prefix = 'test_overfit_endo_direct_predict'
...
if training:
    cell_use = edge_label.loc[edge_label['label']=='Endothelium']
...
rebuilding.output_report(outputdir=outdir,prefix=prefix+'test208-2dim')
